...
/**
 * CLI interface for testing and debugging the npm audit scanner
 */

function printUsage() {
	console.log(`
Bun Audit Scanner CLI
...
Environment Variables:
  NPM_SCANNER_LOG_LEVEL     Set logging level (debug, info, warn, error)
  NPM_SCANNER_TIMEOUT_MS    Set request timeout in milliseconds
  NPM_SCANNER_REGISTRY_URL  Set custom npm registry URL
`);
}
